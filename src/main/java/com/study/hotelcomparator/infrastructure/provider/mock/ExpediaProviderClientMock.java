...
@Service
@Profile("mock")
public class ExpediaProviderClientMock implements ProviderClient {
    private final ProviderRowsMapper providerRowsMapper;
    private final MockProviderFileReader fileReader;

    private static final String RESOURCE = "/mock/expedia.json";

    public ExpediaProviderClientMock(ProviderRowsMapper providerRowsMapper,
    ...
    public List<HotelQuote> fetchOffers(String city,
        ...
        return providerRowsMapper.toHotelQuotes(city, rows, Provider.EXPEDIA);
    }
}
