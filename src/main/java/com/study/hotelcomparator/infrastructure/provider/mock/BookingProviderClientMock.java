...
@Service
@Profile("mock")
public class BookingProviderClientMock implements ProviderClient {
    private final ProviderRowsMapper providerRowsMapper;
    private final MockProviderFileReader fileReader;
    private static final String RESOURCE = "/mock/booking.json";

    public BookingProviderClientMock(ProviderRowsMapper providerRowsMapper,
    ...
    public List<HotelQuote> fetchOffers(String city,
        ...
        return providerRowsMapper.toHotelQuotes(city, rows, Provider.BOOKING);
    }
}
